...
const fixedCommands = Object.freeze([
  ['nav-home', 'Open Today', 'Navigation', 'house', 'navigate', 'overview', 'home command center dashboard'],
  ['nav-agenda', 'Open today’s agenda', 'Navigation', 'calendar-days', 'navigate', 'agenda', 'today available due activities'],
  ...
  ['nav-campaign', 'Jump to Next Up', 'Navigation', 'map', 'navigate-focus', 'campaign', 'recommendation next up'],
  ['nav-activities', 'Open Campaign', 'Navigation', 'list-checks', 'navigate', 'activities', 'activities tasks planner'],
  ['nav-characters', 'Open Characters', 'Navigation', 'users', 'focus-characters', '', 'roster switch character'],
  ['nav-collections', 'Open Collections', 'Navigation', 'gem', 'navigate', 'collections', 'progress mounts appearances pets'],
  ['nav-economy', 'Open Gold', 'Navigation', 'coins', 'navigate', 'gold', 'progress economy gold ledger'],
  ['nav-analytics', 'Open Analytics', 'Navigation', 'chart-no-axes-combined', 'navigate-focus', 'analytics', 'weekly momentum'],
  ['nav-settings', 'Open data & backup', 'Navigation', 'settings', 'navigate-focus', 'settings', 'settings backup import export'],
  ...
  ['session-history', 'Open session history', 'Session', 'history', 'session-history', '', 'history saved completed abandoned'],
